...
#undef UPDATED_VAR
      ...
      //  do {
      //      GetPrivateProfileStringW(L"graphics", L"slang_shader", 0, returned_string, n_size, (std::basic_string<TCHAR>(L".\\") + file_name).c_str());
      //  } while (0);
     ...
     //   if (slang_shader != config->slang_shader_2d) {
      ...
      //  do {
     //       GetPrivateProfileStringW(L"graphics", L"slang_shader_gba", 0, returned_string, n_size, (std::basic_string<TCHAR>(L".\\") + file_name).c_str());
      //  } while (0);
     ...
     //   do {
      //      GetPrivateProfileStringW(L"graphics", L"slang_shader_ds", 0, returned_string, n_size, (std::basic_string<TCHAR>(L".\\") + file_name).c_str());
      //  } while (0);
