...
#ifndef _WIN32_WINNT
#define _WIN32_WINNT 0x0601  // Win7 (matches MinGW's 0x601)
#endif
...
#define MOD_NAME "MMZZXLC FilterMod"
#define LOG_FILE_NAME _T("filter-mod.log")
#define INI_FILE_NAME _T("filter-mod.ini")
