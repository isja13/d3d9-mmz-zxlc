...
class MyID3D9Device : public IDirect3DDevice9 {
    // Class member and method declarations
...
public:
    ...
    HRESULT STDMETHODCALLTYPE CreatePixelShader(const void* pShaderBytecode, SIZE_T BytecodeLength, IDirect3DPixelShader9** ppPixelShader);
    ...
    HRESULT STDMETHODCALLTYPE CreateQuery(const CustomQueryDesc* pQueryDesc, IDirect3DQuery9** ppQuery);
